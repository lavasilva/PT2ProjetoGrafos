...
def export_graph_sample_pyvis(graph, out_dir, max_nodes=100, article_categories=None):
    ...
    _charts_js = (
        ...
        'const CHART_META = {\n'
        '  degree:   {title:"Distribuicao de Graus de Saida",          badge:"EXPLORATORIA"},\n'
        '  ranking:  {title:"Top 15 Hubs",                              badge:"EXPLANATORIA"},\n'
        '  catdist:  {title:"Distribuicao de Artigos por Categoria",    badge:"EXPLORATORIA"},\n'
        '  bfs:      {title:"BFS - Nos por Camada",                     badge:"EXPLORATORIA"},\n'
        '  dfs:      {title:"DFS - Classificacao de Arestas",           badge:"ADICIONAL"},\n'
        '  dijkstra: {title:"Dijkstra - Custo Ponderado e Saltos",      badge:"ADICIONAL"},\n'
        '  bellman:  {title:"Bellman-Ford - 3 Cenarios",                badge:"ADICIONAL"},\n'
        '  perf:     {title:"Desempenho Comparativo dos Algoritmos",    badge:"EXPLANATORIA"},\n'
        '};\n'
        'const INSIGHTS = {\n'
        '  degree: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Histograma da distribuicao do grau de saida de cada artigo (numero de hiperlinks que ele aponta). Eixo Y em escala logaritmica para tornar visivel a cauda longa.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> a distribuicao segue uma <strong>lei de potencia</strong> (power-law), padrao classico de redes de conhecimento. A grande maioria dos artigos tem grau baixo (< 30), enquanto poucos hubs como <strong>United States (294)</strong> e <strong>Driving on the left or right (255)</strong> concentram centenas de conexoes.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>O histograma com escala log no eixo Y e o grafico-padrao para evidenciar redes scale-free: revela tanto a massa de nos comuns quanto a cauda de hubs em uma unica visao.</p></div>`,\n'
        '  ranking: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Os 15 artigos com maior grau de saida, ordenados de cima para baixo. Os 3 primeiros (top 3) destacados em laranja.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> <strong>United States</strong> (294) lidera com mais que 10x a media (26). Artigos com forte vies <strong>geografico-politico</strong> dominam o ranking (paises, listas internacionais), confirmando que estes funcionam como portas de entrada da Wikipedia.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Barras horizontais ordenadas permitem leitura imediata da hierarquia da rede e comparacao direta entre hubs. O destaque dos top 3 reforca a mensagem visual.</p></div>`,\n'
        '  catdist: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Numero total de artigos em cada categoria tematica do Wikispeedia, ordenado do mais para o menos representado.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> <strong>Science (1035)</strong> e <strong>Geography (952)</strong> juntas formam <strong>43%</strong> do dataset. Categorias tecnicas como <strong>Mathematics (43)</strong> e <strong>Art (37)</strong> sao as menos representadas, sugerindo que esses dominios tem menos hiperlinks entre si do que artigos enciclopedicos gerais.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Barras horizontais permitem ler labels longas sem rotacao e exibir o valor absoluto + percentual ao lado de cada barra, dando precisao e contexto simultaneamente.</p></div>`,\n'
        '  bfs: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Para cada uma das 3 fontes BFS (United States, Science, Africa), o numero de nos descobertos em cada camada de profundidade.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> ja na <strong>camada 2 ou 3</strong> a BFS alcanca a maioria dos nos do grafo (> 4000 dos 4604). Isso confirma o fenomeno dos <strong>seis graus de separacao</strong>: o diametro efetivo da rede e pequeno e qualquer artigo esta a poucos cliques de qualquer outro.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Barras agrupadas por fonte permitem comparar o alcance de diferentes pontos de partida lado a lado, evidenciando que o padrao se mantem independente da fonte escolhida.</p></div>`,\n'
        '  dfs: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Para cada fonte DFS, a quantidade de arestas em cada classe: <strong>tree</strong> (arvore principal), <strong>back</strong> (retorno - indica ciclo), <strong>forward</strong> (descendente nao-direto) e <strong>cross</strong> (subarvores diferentes).</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> o numero altissimo de <strong>back-edges (~65000)</strong> em todas as fontes confirma que o grafo do Wikispeedia e <strong>fortemente ciclico</strong>. Praticamente qualquer sequencia de cliques entre artigos cria ciclos. As ~4054 tree-edges sao o esqueleto da arvore de percurso DFS.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>A classificacao de arestas e a analise estrutural mais rica que o DFS oferece - revela a topologia profunda do grafo (presenca de ciclos, hierarquia), nao apenas a ordem de visita.</p></div>`,\n'
        '  dijkstra: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Para cada par origem-destino executado, a distancia ponderada total (soma de 1/grau ao longo do caminho) e o numero de saltos.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> a distancia ponderada nao depende somente do numero de saltos - depende do <strong>grau dos nos intermediarios</strong>. Caminhos que passam por hubs (grau alto) tem peso menor por aresta (1/grau e pequeno). Em outras palavras, <strong>passar por hubs barateia o caminho</strong> mesmo que isso aumente o numero de saltos.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Eixo duplo (barras = distancia, linha = saltos) permite comparar duas metricas de naturezas diferentes na mesma figura sem normalizacao artificial. A tensao entre as duas e o insight central.</p></div>`,\n'
        '  bellman: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Tempo de execucao do Bellman-Ford nos 3 cenarios obrigatorios: pesos originais (todos positivos), aresta com peso negativo injetada (sem ciclo) e ciclo negativo detectado.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> os tempos sao sub-milissegundo porque rodam em <strong>subgrafos de 200 nos</strong> - o Bellman-Ford completo em O(V&middot;E) com 4604 x 119882 seria inviavel (~550M operacoes). Os pesos negativos foram <strong>injetados artificialmente</strong> ja que o dataset real usa apenas 1/grau > 0. O <strong>ciclo negativo foi corretamente detectado</strong>, validando a implementacao.</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Barras com cores semanticas (verde/amarelo/vermelho) comunicam imediatamente a progressao de complexidade dos cenarios sem precisar de legenda extensa.</p></div>`,\n'
        '  perf: `\n'
        '    <div class="ins-section"><h3>O que esta sendo mostrado</h3>\n'
        '    <p>Tempo medio de execucao de cada algoritmo nas tarefas obrigatorias da Parte 2, agrupado por algoritmo.</p></div>\n'
        '    <div class="ins-box">&#128161; <strong>Insight principal:</strong> <strong>BFS</strong> e o mais rapido (~50ms) e <strong>DFS</strong> e bem mais lento (~7s) apesar de ambos serem O(V+E) - o overhead vem da pilha de recursao e classificacao de arestas. <strong>Dijkstra</strong> (~0.6s) e mais lento que BFS pelo custo do heap (O((V+E)logV)) mas garante o caminho ponderado otimo. <strong>Bellman-Ford</strong> e impraticavel no grafo completo (so funciona em subgrafos).</div>\n'
        '    <div class="ins-section"><h3>Por que este tipo de grafico</h3>\n'
        '    <p>Comparar tempo medio entre algoritmos em barras lado a lado e a forma mais direta de comunicar a diferenca pratica de desempenho. Conecta teoria (complexidade) e empiria (tempo medido).</p></div>`,\n'
        '};\n'
        '\n'
        ...
        '  badge.className = "cm-badge cm-badge-" + (meta.badge||"").toLowerCase();\n'
...
<div id="sb">
  ...
  <div id="tab-analyses" class="sb" style="display:none">
    ...
    <hr class="divr">
    <button class="cbtn" onclick="openDashModal()" style="background:#0f2540;border-color:var(--accent);color:var(--accent)">
      📋 Dashboard Analítico<br><span class="cbtn-sub" style="color:#2dd4bf88">VISÃO GERAL</span>
    </button>
  </div>
